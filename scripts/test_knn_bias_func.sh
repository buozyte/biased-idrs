...
python certify.py toy_dataset_linear_sep trained_models/toy/noise_0.25/bias_0.0/mu_knn_based/checkpoint_biased_id.pth.tar 0.25 data/certify/toy/noise_0.25/bias_0.0 --skip 1 --batch 200
